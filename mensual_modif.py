...
archivo1 = open("sc_mensual.out","r")
...
contenido1 += "archivo1 = open('sc_mensual.out','w')\n"
contenido1 += "archivo1.write(contenido2)\n"
contenido1 += "archivo1.close"



archivo2 = open(ruta+"mensual_modif2.py","w")
archivo2.write(contenido1)

os.system("chmod 777 "+ruta+"mensual_modif2.py")

archivo2.close()

os.system("mensual_modif2.py")
