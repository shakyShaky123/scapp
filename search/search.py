...
cur.execute("\
		...
		WHERE \
			...
			/*AND Origin.time_value BETWEEN '20171001000000' AND '20171002000000'*/\
			...
			/*AND (Event.type NOT IN ('not locatable', 'explosion', 'not existing') OR Event.type IS NULL) */\
			/*AND EventDescription.type = 'region name' AND EventDescription.text LIKE '%Colombia%' */\
